COPY organization(organization_id, organization_name, website, phone_number, org_address, org_description, schedule, gender, kids) FROM '/Users/erineckerman/projects/emerald-city-resource-guide/organization.csv' DELIMITER ',' CSV HEADER;
